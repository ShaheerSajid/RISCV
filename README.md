...
Steps to compile project:
 ...
 4. Open tools/platform designer and edit system-on-chip ram IP.
 5. Give path of hex file generated by the compiler (See Programming section)
 6. Save and generate
 7. Compile Quartus project
 8. You only need to compile once after which just update memory initialization files and program device again.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyNzIxMjk3MSwtMjAwNjYxMDAzMiwzMj
