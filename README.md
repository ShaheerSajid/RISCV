...
Hardware divide is removed to reduce LE usage but that can be incorporated into the core if needed. FPU supports all F-instructions except divide again for the purposes of reducing area. The FPU is single cycle so this has reduced the overall FMAX of the core. I will address this issue in the feature when the
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTA0NzUxNDksLTQ0MDA2Njc2NSw2Mz
