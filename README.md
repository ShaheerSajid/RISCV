...
To prevent data hazards, port forwarding is done in the decode stage. The second port forwarding is done in the execution stage where data from data memory is forwarded.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQwNTI1MTUzLDYzMDk2ODI1NywxMDI3Mj
