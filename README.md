...
### Steps to compile project:
 ...
 4. Open tools/platform designer and edit system-on-chip ram IP. Give path of hex file generated by the compiler (See Programming section). Also edit Core and check whatever features you need in the core. 
 6. Save and generate
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4OTUyMjgxOCwxNDUyMjkwNzAyLC0xOT
