...
Hardware divide is removed to reduce LE usage but that can be incorporated into the core if needed. FPU supports all F-instructions except divide ag
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5MDQzNjE2MywtNDQwMDY2NzY1LDYzMD
